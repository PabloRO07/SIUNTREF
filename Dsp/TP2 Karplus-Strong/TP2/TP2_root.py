...
fig, ((ax1,ax2 ),(ax3,ax4)) = plt.subplots(nrows=2, ncols=2,sharex='col',figsize=(16, 10))
fig.suptitle(r'$ Analisis \ del \ sistema \ 1 \ ecos \ finito $',fontsize=18,fontname="Times New Roman Bold")
...
fig.suptitle(r'$ Analisis \ del \ sistema \ 2 \ Feedback \ delay $',fontsize=18,fontname="Times New Roman Bold")
